...
const LinaAssistant = ({ onClose }: LinaAssistantProps) => {
  ...
  const linaResponses = {
    'привет': 'Привет! Я всегда рада видеть тебя! 😊\n\nЯ помогу найти информацию о Горхоне. Что тебя интересует?',
  ...
  useEffect(() => {
    const loadMessages = () => {
      ...
      const welcomeMessage: Message = {
        id: '1',
        text: 'Привет! Я Лина — твой голосовой помощник! 😊\n\nГотова помочь с любыми вопросами о жизни в Горхоне. Что тебя интересует?',
        isUser: false,
        timestamp: new Date()
      };
